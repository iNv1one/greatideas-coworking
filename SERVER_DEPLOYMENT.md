# 🚀 Деплоймент GreatIdeas с Telegram Payments на сервер

## 🏗️ Архитектура развертывания

### Что мы развертываем:
```
Интернет → Nginx (HTTPS) → Gunicorn → Django Web App + Telegram Bot
                                            ↓
...
- Сайт с каталогом кафе и меню
- Корзина и система заказов
- Telegram Web App интеграция
- API для платежей

**🤖 Telegram Bot** - Платежный бот
- Авторизация через Telegram
- Обработка платежей ЮKassa
- Отправка инвойсов
- Уведомления о заказах

**� Telegram Payments** - Платежная система
